...
// Core Calming Base (backgrounds, large areas)
final Color softWarmWhite = Color(0xffFAFAFA);
final Color gentleSage = Color(0xffDCEFE7);
final Color powderBlue = Color(0xffDDEAF6);

// ✨ Accent / Focus Colors (used sparingly to guide attention)
final Color lavenderMist = Color(0xffC9C8F9);
